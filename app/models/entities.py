...
class Camera(Base, TimestampMixin):
    ...
    camera_type: Mapped[str] = mapped_column(String(60), default="generic_rtsp")
    ...
    rtsp_transport: Mapped[str] = mapped_column(String(20), default="automatic")
    ...
    last_status: Mapped[str | None] = mapped_column(Text, default="unknown")
